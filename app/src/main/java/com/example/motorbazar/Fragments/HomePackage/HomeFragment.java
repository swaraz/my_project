...
import com.example.motorbazar.ChangePassword;
import com.example.motorbazar.Chart;
...
import com.example.motorbazar.Sort.SortItems;
import com.example.motorbazar.SplashScreenPackage.SplashScreen;
import com.example.motorbazar.MyProfile;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        int id =item.getItemId();
            if (id == R.id.notification) {
                ...
                startActivity(new Intent(getContext(), Chart.class));
            }
                ...
                startActivity(new Intent(getContext(), SortItems.class));
            }
