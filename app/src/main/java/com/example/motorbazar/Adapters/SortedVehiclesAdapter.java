...
public class SortedVehiclesAdapter extends RecyclerView.Adapter<SortedVehiclesAdapter.VehicleViewHolder> {
    ...
    public SortedVehiclesAdapter(Context context, ArrayList<ListedVehicle> vehicleList) {
